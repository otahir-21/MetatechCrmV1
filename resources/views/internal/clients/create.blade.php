...
<head>
    ...
    <title>Create New Client - Metatech Internal CRM</title>
...
<div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Add a new digital marketing client</p>
                </div>
            </div>
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form action="{{ route('internal.clients.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                           ...
                           placeholder="e.g., ABC Digital Solutions">
                    @error('name')
