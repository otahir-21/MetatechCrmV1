...
<div class="bg-white py-8 px-6 shadow rounded-lg">
    <div class="mb-6">
        @if(isset($loginType) && $loginType === 'company')
            <h2 class="text-2xl font-bold text-gray-900 text-center">Company Login</h2>
            <p class="mt-2 text-sm text-gray-600 text-center">
                Login to access {{ $companyName ?? 'your company' }} dashboard
            </p>
        @elseif(isset($loginType) && $loginType === 'internal')
            <h2 class="text-2xl font-bold text-gray-900 text-center">Internal CRM Login</h2>
            <p class="mt-2 text-sm text-gray-600 text-center">
                Login to access Internal CRM Dashboard
            </p>
        @else
            <h2 class="text-2xl font-bold text-gray-900 text-center">Product Owner Login</h2>
            <p class="mt-2 text-sm text-gray-600 text-center">
...
document.getElementById('loginForm').addEventListener('submit', function(e) {
    ...
    // If there are validation errors, they will be shown via the error block above
});
</script>
@endsection
